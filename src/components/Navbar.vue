...
export default {
  ...
  computed: {
    ...
    'settings.rows': {
      get () {
        return this.$store.state.gameSettings.rows
      },
      set (val) {
        this.$store.state.gameSettings.rows = +val
      }
    },
    'settings.columns': {
      get () {
        return this.$store.state.gameSettings.columns
      },
      set (val) {
        this.$store.state.gameSettings.columns = +val
      }
    },
    'settings.mines': {
      get () {
        return this.$store.state.gameSettings.mines
      },
      set (val) {
        this.$store.state.gameSettings.mines = +val
      }
    } */
  },
  methods: {
